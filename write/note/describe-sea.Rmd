...
trac_atd <- read_delim(here::here('write', 'input', 'trac_atd_2024-02-24.csv'), delim=',')
...
ggsave('seattle-nondetained-outcome.png', dpi="retina", width=7, height=5, bg="white")
